...
class WooCommerce_Widget_Login_CUSTOM extends WP_Widget {
	...
	function WooCommerce_Widget_Login_CUSTOM() {
		...
		$this->woo_widget_description_custom = __( 'Display a login area and "My Account" links in the sidebar.', 'woocommerce' );
		$this->woo_widget_idbase_custom = 'Custom woocommerce_login';
		$this->woo_widget_name_custom = __('Custom WooCommerce Login', 'woocommerce' );
	...
	function widget( $args, $instance ) {
		...
		if (is_user_logged_in()) {
			...
			<form method="post">
				...
				<p class="submit_form"><input type="submit" class="submitbutton" name="wp-submit" id="wp-submit" value="<?php _e('Login &rarr;', 'woocommerce'); ?>" /> <a href="<?php echo wp_lostpassword_url(); ?>"><?php echo __('Lost password?', 'woocommerce'); ?></a></p>
